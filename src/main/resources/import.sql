...
-- Endereços
INSERT INTO endereco (rua, bairro, cidade, estado, cep, pais) VALUES ('Sítio São Felix', 'Zona Rural', 'Santo Andre', 'Paraíba', '58670-000', 'Brasil');

INSERT INTO endereco (rua, bairro, cidade, estado, cep, pais) VALUES ('Sítio Jacaré', 'Zona Rural', 'Juazeirinho', 'Paraíba', '58660-000', 'Brasil');

-- Fazendas
INSERT INTO capril (nome, TOD, user_id, address_id, criado_em, atualizado_em) VALUES ('Capril Vilar', '16432', 1, 1, NOW(), NOW());

INSERT INTO capril (nome, TOD, user_id, address_id, criado_em, atualizado_em) VALUES ('Capril Medeiros', '99887', 2, 2, NOW(), NOW());
...
INSERT INTO eventos (goat_registration_number, tipo_evento, data, descricao, local, veterinario, resultado) VALUES ('2114517012', 'SAUDE', '2025-05-05', 'Apresentou sintomas de mastite clínica', 'Capril Vilar', 'Dr. Carlos Mendes', 'Iniciado tratamento com antibiótico específico. Isolamento recomendado por 5 dias.');
