 ...
 */
@Component
@ConditionalOnProperty(value = "caprigestor.messaging.enabled", havingValue = "false", matchIfMissing = true)
public class NoOpEventPublisher implements EventPublisher {
    ...
    public void publishEvent(EventPublication event) {
        if (event != null) {
            log.debug("Mensageria desabilitada. Evento não publicado: id={}", event.eventId());
        }
    }
}
