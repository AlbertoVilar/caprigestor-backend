...
public interface HealthEventPersistencePort {
    ...
    HealthEvent save(HealthEvent event);

    Optional<HealthEvent> findByIdAndFarmIdAndGoatId(Long eventId, Long farmId, String goatId);

    Page<HealthEvent> findByFarmIdAndGoatId(
            Long farmId,
            String goatId,
            LocalDate from,
            LocalDate to,
    ...
    Page<HealthEvent> findByFarmIdAndPeriod(
            Long farmId,
            LocalDate from,
            LocalDate to,
            HealthEventType type,
