...
public class HttpRequestLoggingFilter extends OncePerRequestFilter {
    ...
    private String resolveCorrelationId(String receivedCorrelationId) {
        if (receivedCorrelationId != null && SAFE_CORRELATION_ID.matcher(receivedCorrelationId).matches()) {
