 ...
 */
public interface LegacyGoatPersistencePort {
     ...
     * @return Cabra salva
     */
    GoatEntity save(GoatEntity goat);
     ...
     */
    Optional<GoatEntity> findById(String registrationNumber);
     ...
     */
    List<GoatEntity> findByGoatFarmId(Long goatFarmId);
     ...
     */
    Page<GoatEntity> findAllByFarmId(Long goatFarmId, Pageable pageable);

    Page<GoatEntity> findAllByFarmIdAndBreed(Long goatFarmId, GoatBreed breed, Pageable pageable);
     ...
     */
    Page<GoatEntity> findByNameAndFarmId(Long goatFarmId, String name, Pageable pageable);

    Page<GoatEntity> findByNameAndFarmIdAndBreed(Long goatFarmId, String name, GoatBreed breed, Pageable pageable);

    List<GoatEntity> findOffspringByParentRegistration(Long goatFarmId, String parentRegistrationNumber);
     ...
     * @return Optional contendo a cabra se encontrada
     */
    Optional<GoatEntity> findByIdAndFarmId(String id, Long farmId);
