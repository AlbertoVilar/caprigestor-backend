...
[📚 Portal de Documentação](./docs/INDEX.md) • [📋 Arquitetura](./docs/ARCHITECTURE.md) • [💼 Domínio](./docs/BUSINESS_DOMAIN.md) • [🖥️ Frontend](https://github.com/albertovilar/caprigestor-frontend) • [📊 Swagger](http://localhost:8080/swagger-ui/index.html)
